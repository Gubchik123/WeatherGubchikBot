...
@router.message(IsAdmin(), Command(commands=["all_users_count"]))
...
@router.message(IsAdmin(), Command(commands=["all_users"]))
...
@router.message(IsAdmin(), Command(commands=["all_mailing_users_count"]))
...
@router.message(IsAdmin(), Command(commands=["all_mailing_users"]))
...
@router.message(IsAdmin(), Command(commands=["user"]))
